...
queryData("DESKTOP-IEKNRR8\SQLEXPRESS", "baseball", "{ODBC Driver 17 for SQL Server}", "select * from PitchingStats").to_json('backend/jsonData/baseballPitchingStats.json', orient='records', indent=4)
