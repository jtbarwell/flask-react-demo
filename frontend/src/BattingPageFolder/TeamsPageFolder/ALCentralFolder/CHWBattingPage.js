...
export default function CHWBattingPage() {
    ...
    return (
        <div>
            <h1>Chicago White Sox Batting</h1>

            <label htmlFor="years">Batting Statistics for the Chicago White Sox:</label>
            ...
            <div style={{ display: 'inline-block' }}>
                ...
                <BattingTable data={batting} condition={row => row.Team === "CHW" && condition(row)} />
            </div>
        </div>
    );
}
