...
export default function CLEBattingPage() {
    ...
    return (
        <div>
            <h1>Cleveland Guardians Batting</h1>

            <label htmlFor="years">Batting Statistics for the Cleveland Guardians:</label>
            ...
            <div style={{ display: 'inline-block' }}>
                ...
                <BattingTable data={batting} condition={row => row.Team === "CLE" && condition(row)} />
            </div>
        </div>
    );
}
