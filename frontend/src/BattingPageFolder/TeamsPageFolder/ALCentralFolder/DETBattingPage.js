...
export default function DETBattingPage() {
    ...
    return (
        <div>
            <h1>Detroit Tigers Batting</h1>

            <label htmlFor="years">Batting Statistics for the Detroit Tigers:</label>
            ...
            <div style={{ display: 'inline-block' }}>
                ...
                <BattingTable data={batting} condition={row => row.Team === "DET" && condition(row)} />
            </div>
        </div>
    );
}
