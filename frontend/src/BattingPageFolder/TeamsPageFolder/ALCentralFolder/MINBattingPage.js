...
export default function MINBattingPage() {
    ...
    return (
        <div>
            <h1>Minnesota Twins Batting</h1>

            <label htmlFor="years">Batting Statistics for the Minnesota Twins:</label>
            ...
            <div style={{ display: 'inline-block' }}>
                ...
                <BattingTable data={batting} condition={row => row.Team === "MIN" && condition(row)} />
            </div>
        </div>
    );
}
