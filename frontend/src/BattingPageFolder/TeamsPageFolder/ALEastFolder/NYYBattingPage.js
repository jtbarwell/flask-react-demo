...
export default function NYYBattingPage() {
	...
	return (
		<div>
			<h1>New York Yankees Batting</h1>

            <label htmlFor="years">Batting Statistics for the New York Yankees:</label>
            ...
            <div style={{ display: 'inline-block' }}>
                ...
                <BattingTable data={batting} condition={row => row.Team === "NYY" && condition(row)} />
            </div>
		</div>
	);
}
