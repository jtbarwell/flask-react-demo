...
export default function TEXBattingPage() {
    ...
    return (
        <div>
            <h1>Texas Rangers Batting</h1>

            <label htmlFor="years">Batting Statistics for the Texas Rangers:</label>
            ...
            <div style={{ display: 'inline-block' }}>
                ...
                <BattingTable data={batting} condition={row => row.Team === "TEX" && condition(row)} />
            </div>
        </div>
    );
}
