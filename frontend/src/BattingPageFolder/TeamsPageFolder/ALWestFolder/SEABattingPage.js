...
export default function SEABattingPage() {
    ...
    return (
        <div>
            <h1>Seattle Mariners Batting</h1>

            <label htmlFor="years">Batting Statistics for the Seattle Mariners:</label>
            ...
            <div style={{ display: 'inline-block' }}>
                ...
                <BattingTable data={batting} condition={row => row.Team === "SEA" && condition(row)} />
            </div>
        </div>
    );
}
