...
export default function LAABattingPage() {
    ...
    return (
        <div>
            <h1>Los Angeles Angels Batting</h1>

            <label htmlFor="years">Batting Statistics for the Los Angeles Angels:</label>
            ...
            <div style={{ display: 'inline-block' }}>
                ...
                <BattingTable data={batting} condition={row => row.Team === "LAA" && condition(row)} />
            </div>
        </div>
    );
}
