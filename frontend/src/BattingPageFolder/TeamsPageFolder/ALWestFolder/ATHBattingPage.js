...
export default function ATHBattingPage() {
	...
	return (
		<div>
			<h1>Athletics Batting</h1>

            <label htmlFor="years">Batting Statistics for the Athletics:</label>
            ...
            <div style={{ display: 'inline-block' }}>
                ...
                <BattingTable data={batting} condition={row => row.Team === "ATH" && condition(row)} />
            </div>
		</div>
	);
}
