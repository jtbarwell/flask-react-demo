...
export default function HOUBattingPage() {
	...
	return (
		<div>
			<h1>Houston Astros Batting</h1>

            <label htmlFor="years">Batting Statistics for the Houston Astros:</label>
            ...
            <div style={{ display: 'inline-block' }}>
                ...
                <BattingTable data={batting} condition={row => row.Team === "HOU" && condition(row)} />
            </div>
		</div>
	);
}
